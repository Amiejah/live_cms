...
tinymce.init({
    ...
    theme: 'modern',
    skin: 'light',
    plugins: 'code emoticons table spellchecker responsivefilemanager',
    tools: 'table',
    theme_advanced_buttons1 : "bold,italic,underline,strikethrough,separator,justifyleft,justifyright,justifycenter,justifyfull,separator,bullist, numlist,outdent,indent,separator,cut,copy,paste,separator,unlink,link,separator,phpimage,separator,formatselect,code,fullscreen, responsivefilemanager",

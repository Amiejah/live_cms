        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                tbl += '<table class="table top_widget">';
                    tbl += '<thead>';
                        tbl += '<tr>';
                            tbl += '<th class="widget_count">#</th>';
                            tbl += '<th class="widget_title">Casino</th>';
                            tbl += '<th class="widget_ratings">Rating</th>';
                            tbl += '<th class="widget_bonus">Welkomst bonus</th>';
                            tbl += '<th class="widget_download">Download/review</th>';
                        tbl += '</tr>';
                    tbl += '</thead>';
                    tbl += '<tbody>';
                        $.each(data, function() {
                            if( data[i]['widget_status'] == 1) {
                                tbl += '<tr>';
                                    ...
                                    tbl += '<td class="widget_count">' + c + '</td>';
                                    ...
                                    tbl += '</td>';
                                    tbl += '<td class="widget_ratings">ratings</td>';
                                    tbl += '<td class="widget_bonus">bonus</td>';
                                    tbl += '<td class="widget_download">casino' + data[i]['widget_id'] + '/' + data[i]['widget_slug'] + '</td>';
